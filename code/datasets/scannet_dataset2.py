...
class ScanNetDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.train_list = np.loadtxt(os.path.join(data_dir, 'train_split.txt')).astype(int).tolist()
        self.test_list = np.loadtxt(os.path.join(data_dir, 'test_split.txt')).astype(int).tolist()
